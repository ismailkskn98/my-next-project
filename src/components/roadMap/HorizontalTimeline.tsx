  ...
  return (
    ...
    >
      <div className="relative w-full">
        <div className="absolute left-0 right-0 top-1/2 h-0.5 w-full -translate-y-1/2 rounded-full bg-white/50" />
          ...
          {milestones.slice(0, 6).map((item, index) => (
            ...
            >
              <div className="absolute left-1/2 top-1/2 z-10 h-4 w-4 -translate-x-1/2 transform rounded-full bg-primary md:top-[calc(50%-0.5rem)]">
                <div className="2xl: bg-[#FFD700 ] absolute left-1/2 top-1/2 h-2 w-2 -translate-x-1/2 -translate-y-1/2 transform rounded-full" />
              </div>

              <div
                className={cn(
                  "absolute left-1/2 w-0.5 bg-white/50",
